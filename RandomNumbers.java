public class RandomNumbers {
  public static void main(String[] args) {
    ...
    // will pick four random integers, each 1-10
    ...
    // will pick four random intergers, each 1-6
    ...
    //will pick a single random integer, 1-100
    a = 1 + (int)(100*Math.random() );
    System.out.println("1-100:\t" +a +"\t" +b +"\t" +c +"\t" +d);

    //will pick four random integers, each 1-100
    a = 1 + (int)(100*Math.random() );
    ...
    // will pick four random integers, each 0-99
    ...
    // will pick four random integers, each 10-20
